...
class DuolinguistFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(config_entry):
        return DuolinguistOptionsFlowHandler(config_entry)
...
class DuolinguistOptionsFlowHandler(config_entries.OptionsFlow):
    """Duolinguist config flow options handler."""
